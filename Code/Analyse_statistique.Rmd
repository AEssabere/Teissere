...
regression_lineaire_simple = function(sirop){
  ...
  pc = predict(regression, data.frame(temperatures),level=0.95,interval = "confidence")
  points(temperatures, pc[,2], type='l',col="turquoise")
  points(temperatures, pc[,3], type='l',col="turquoise")
  
  # calcul et trace de l'intervalle de prediction
  pp = predict(regression,data.frame(temperatures),level = 0.95, interval = "prediction")
  points(temperatures, pp[,2], type='l',col="pink")
  points(temperatures, pp[,3], type='l',col="pink")
